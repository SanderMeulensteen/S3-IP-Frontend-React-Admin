...
import { CompetitionCreate, CompetitionEdit, CompetitionList } from "./components/Competition";
...
import { PositionCreate, PositionEdit, PositionList } from "./components/Position";
...
const App = () => (
      <Admin dataProvider={dataProvider}>
          ...
          <Resource name="positions" list={PositionList} edit={PositionEdit} create={PositionCreate} />
      </Admin>
  );
